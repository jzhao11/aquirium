...
//			e > 0 ? f.prev() : f.next()
   ...
   $('.banner_centertxt').css('bottom',($(window).height() - $('.banner_centertxt').height())/2)
...
//      grabCursor:true, /*小手  鼠标悬浮swiper样式*/
     ...
     var sswiper = new Swiper('.swiper-news-auto', {
        effect : 'coverflow',
        grabCursor: true,
        autoplay: 3000,
    });
	...
	//宇宙特效
	"use strict";
	var canvas = document.getElementById('canvas_page5'),
	...
	animation();
     ...
     var map = new BMap.Map("baiduMap");  //创建Map实例
	  var point = new BMap.Point(117.2181910000,39.1357850000);  //创建point位置
	  map.centerAndZoom(point, 14);  //设置地图中心点及缩放级别
...
$('.page_content2 ul li').mouseover(function(){
	$('.page_content2 ul li').eq(0).removeClass('fist_select')
})
